...
void sort(Zodiac* S, int B[][3], const int N);
void search(Zodiac* S, int B[][3], const int N, const string f_surname);
...
void sort(Zodiac* S, int B[][3], int N)
{
    Zodiac temp;
    int btemp;
    for (int i = 0; i < N; i++)
